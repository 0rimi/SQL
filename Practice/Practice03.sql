...
select em.employee_id, em.first_name, em.salary,
...
select em.employee_id, em.first_name, em.hire_date, ma.first_name, ma.hire_date
...
--값이 없는 경우 표시하지 않습니다.
--(27건)
select co.country_name, co.country_id, lo.city, lo.location_id,
        de.department_name, de.department_id
